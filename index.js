...
async function connectToWA() {
  ...
  console.log("Connecting ✗ ZORO - BOT ✗");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("✗ ZORO - BOT ✗ installed successful ✅");
      console.log("✗ ZORO - BOT ✗ connected to whatsapp ✅");

      let up = `✗ ZORO - BOT ✗ connected successful ✅`;
      ...
      robin.sendMessage("94729581028@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Dark-Robin/Bot-Helper/refs/heads/main/autoimage/Bot%20robin%20cs.jpg`,
        },
        caption: up1,
